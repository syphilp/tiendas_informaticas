<?php /* Smarty version Smarty-3.1.19, created on 2016-10-04 09:54:24
         compiled from "C:\xampp\htdocs\tiendas_informatica\themes\default-bootstrap\order-steps.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2917557f360300adea0-38521377%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e1c1ea43f3dfe50992563081539ca2dde2a93b55' => 
    array (
      0 => 'C:\\xampp\\htdocs\\tiendas_informatica\\themes\\default-bootstrap\\order-steps.tpl',
      1 => 1473167114,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2917557f360300adea0-38521377',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57f360301cf6c6_81557797',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57f360301cf6c6_81557797')) {function content_57f360301cf6c6_81557797($_smarty_tpl) {?>
...
">
	...
	<li class="<?php if ($_smarty_tpl->tpl_vars['current_step']->value=='shipping') {?>step_current<?php } else { ?><?php if ($_smarty_tpl->tpl_vars['current_step']->value=='payment') {?>step_done step_done_last<?php } else { ?>step_todo<?php }?><?php }?> four">
		...
		<a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['multi_shipping']->value) {?><?php echo "&multi-shipping=";?><?php echo (string)$_smarty_tpl->tpl_vars['multi_shipping']->value;?><?php }?><?php $_tmp42=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,((string)Smarty::$_smarty_vars['capture']['url_back'])."&step=2".$_tmp42), ENT_QUOTES, 'UTF-8', true);?>
">
