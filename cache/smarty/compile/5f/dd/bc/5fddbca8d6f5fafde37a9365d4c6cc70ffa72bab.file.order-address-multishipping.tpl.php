<?php /* Smarty version Smarty-3.1.19, created on 2016-10-04 09:54:10
         compiled from "C:\xampp\htdocs\tiendas_informatica\themes\default-bootstrap\order-address-multishipping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2914857f36022201af2-44183686%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5fddbca8d6f5fafde37a9365d4c6cc70ffa72bab' => 
    array (
      0 => 'C:\\xampp\\htdocs\\tiendas_informatica\\themes\\default-bootstrap\\order-address-multishipping.tpl',
      1 => 1473167114,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2914857f36022201af2-44183686',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57f3602236b2c8_05039996',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57f3602236b2c8_05039996')) {function content_57f3602236b2c8_05039996($_smarty_tpl) {?>
...
<?php $_tmp19=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp20=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp19.$_tmp20), ENT_QUOTES, 'UTF-8', true);?>
...
<i class="icon-chevron-right right"></i></span></a>
	...
	<p class="address_add submit">
		<a href="<?php ob_start();?><?php echo urlencode('&multi-shipping=1');?>
<?php $_tmp21=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo urlencode($_smarty_tpl->tpl_vars['back']->value);?>
<?php }?><?php $_tmp22=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp21.$_tmp22), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
" class="button button-small btn btn-default"><span><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
<i class="icon-chevron-right right"></i></span></a>
	</p>
